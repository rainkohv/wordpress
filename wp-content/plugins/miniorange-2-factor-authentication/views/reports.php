...
echo'	<div>
		...
		<table>
            <tr>
		        ...
		        <td>
                    <input type="submit"" class="mo_wpns_button mo_wpns_button1" value="Clear Login Reports" />
                </td>
            </tr>
        </table>
		<br>
			...
			<div class="mo_wpns_setting_layout hidden">	
				...
				<form id="mo_wpns_advanced_reports" method="post" action="">
					...
					<br><input type="submit" name="Search" style="width:100px;" value="Search" class="mo_wpns_button mo_wpns_button1">
				</form>
				<br>
			</div>
...
echo'	        </tbody>
		...
		<table>
            <tr>
		        ...
		        <td>
                    <input type="submit"" class="mo_wpns_button mo_wpns_button1" value=" Clear Error Reports" />
                </td>
            </tr>
        </table>
		<br>
