...
echo'	  <div class="mo_wpns_divided_layout">
          <div class="mo_wpns_table_layout mo_wpns_setting_layout">
			<div id="panel2">
				...
				<!-- Enter otp -->
					<form name="f" method="post" id="wpns_form" action="">
						...
						<tr><td></td><td>
						<a style="cursor:pointer;" onclick="document.getElementById(\'mo_wpns_cancel_form\').submit();"><input type="button" value="Back" id="back_btn" class="mo_wpns_button mo_wpns_button1" /></a>
						<input type="submit" value="Validate OTP" class="mo_wpns_button mo_wpns_button1" />
						</td>
						</form>
						<td>
				...
				<form id="phone_verification" method="post" action="">
					<input type="hidden" name="option" value="mo_wpns_phone_verification" />
					 ...
					 <br><br>
						...
						<br><input type="submit" value="Send OTP" class="mo_wpns_button mo_wpns_button1" />
