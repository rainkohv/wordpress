	...
	echo'		<h3>Content Protection</h3>
				<form id="mo_wpns_content_protection" method="post" action="">
					...
					<br><input type="submit" name="submit" style="width:100px;" value="Save" class="mo_wpns_button mo_wpns_button1">
				</form>
			</div>';
	...
	echo '
		...
		{ 
			...
			<form id="mo_wpns_comment_recaptcha_settings" method="post" action="">
				...
				<input type="submit" value="Save Settings" class="mo_wpns_button mo_wpns_button1" />
				<input type="button" value="Test reCAPTCHA Configuration" onclick="testRecaptchaConfiguration()" class="mo_wpns_button mo_wpns_button1" />
			</form>';
		}
